            ...
            <div class="flex items-end gap-16">
              <div class="flex-1">
                ...
                <div class="form-control">
                  ...
                  <input name="name" type="text" placeholder="Enter the mountain name" class="input input-bordered">
                  <label class="label">
                ...
                <div class="form-control">
                  ...
                  <textarea name="description" placeholder="Enter the mountain name" class="textarea h-24 textarea-bordered"></textarea>
                  <label class="label">
                ...
                <div class="form-control">
                  ...
                  <label class="input-group">
                    <input name="altitude" type="number" value="500" min="1" class="input input-bordered">
